...
void loop()
{
  ...
  { 
    ...
    strip.setPixelColor(0, strip.Color(0,255,0)); //Sets colour of pixel 0 to green
    strip.show(); //Carrying out gating on the pixel
    delay (pause); //Break
    ...
    strip.setPixelColor(0, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(59, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(1, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(58, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(2, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(57, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(3, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(56, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(4, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(55, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(5, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(54, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(6, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(53, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(7, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(52, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(8, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(51, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(9, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(50, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(10, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(49, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(11, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(48, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(12, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(47, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(13, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(46, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(14, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(45, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(15, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(44, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(16, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(43, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(17, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(42, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(18, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(41, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(19, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(40, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(20, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(39, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(21, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(38, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(22, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(37, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(23, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(36, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(24, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(35, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(25, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(34, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(26, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(33, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(27, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(32, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(28, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(31, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(29, strip.Color(0,200,200));
    strip.show();
    delay (pause);
    strip.setPixelColor(30, strip.Color(0,200,200));
    strip.show();
    ...
    strip.show();    
    strip.setPixelColor(30, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(31, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(32, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(33, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(34, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(35, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(36, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(37, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(38, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(39, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(40, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(41, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(42, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(43, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(44, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(45, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(46, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(47, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(48, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(49, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(50, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(51, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(52, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(53, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(54, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(55, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(56, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(57, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(58, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(59, strip.Color(0,0,200));
    strip.show();

    delay (pauseM); //Break
    
    strip.setPixelColor(45, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(46, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(47, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(48, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(49, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(50, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(51, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(52, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(53, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(54, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(55, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(56, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(57, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(58, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(59, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(0, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(1, strip.Color(200,0,0));
    ...
    strip.setPixelColor(14, strip.Color(200,0,0));
    strip.show();
    strip.setPixelColor(15, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(16, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(17, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(18, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(19, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(20, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(21, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(22, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(23, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(24, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(25, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(26, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(27, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(28, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(29, strip.Color(0,0,200));
    strip.show();    
    strip.setPixelColor(30, strip.Color(0,0,200));
    strip.show();
    strip.setPixelColor(31, strip.Color(0,0,200));
    ...
    strip.setPixelColor(0, strip.Color(70,170,70)); 
    strip.show(); 
    delay (pause); 
    strip.setPixelColor(15, strip.Color(70,170,70)); 
    strip.show();
    delay (pause); 
    strip.setPixelColor(30, strip.Color(70,170,70)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(45, strip.Color(70,170,70));
    strip.show(); 
    delay (pause);
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(31, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(46, strip.Color(70,255,222));
    strip.show(); 
    delay (pause); 
    ...
    strip.show(); 
    delay (pause);
    strip.setPixelColor(47, strip.Color(70,255,222));
    strip.show(); 
    delay (pause);
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(33, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(48, strip.Color(0,255,0)); 
    strip.show(); 
    delay (pause); 
    strip.setPixelColor(4, strip.Color(0,0,255)); 
    strip.show();
    delay (pause); 
    strip.setPixelColor(19, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(34, strip.Color(70,255,222));
    strip.show(); 
    delay (pause);
    strip.setPixelColor(49, strip.Color(0,255,0)); 
    strip.show(); 
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(20, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(35, strip.Color(70,255,222));
    strip.show(); 
    delay (pause); 
    ...
    strip.show(); 
    delay (pause);
    strip.setPixelColor(36, strip.Color(70,255,222));
    strip.show(); 
    delay (pause);
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(22, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(8, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(23, strip.Color(70,255,222));
    strip.show(); 
    delay (pause);
    strip.setPixelColor(38, strip.Color(0,255,0)); 
    strip.show(); 
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(9, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(24, strip.Color(70,255,222));
    strip.show(); 
    delay (pause); 
    ...
    strip.show(); 
    delay (pause);
    strip.setPixelColor(25, strip.Color(70,255,222));
    strip.show(); 
    delay (pause);
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(11, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(56, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(12, strip.Color(70,255,222));
    strip.show(); 
    delay (pause);
    strip.setPixelColor(27, strip.Color(0,255,0)); 
    strip.show(); 
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(57, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(13, strip.Color(70,255,222));
    strip.show(); 
    delay (pause); 
    ...
    strip.show();
    delay (pause); 
    strip.setPixelColor(58, strip.Color(200,22,0)); 
    strip.show(); 
    delay (pause);
    strip.setPixelColor(14, strip.Color(70,255,222));
    strip.show(); 
    delay (pause);
    ...
    strip.setPixelColor(57, strip.Color(0,255,0));
    strip.show();
    strip.setPixelColor(58, strip.Color(0,255,0));
    strip.show();
